...
export const metadata: Metadata = createMetadata({
  title: "About Us",
  description:
    "Learn about Kyron Solutions — our mission, values, and the experienced team behind 150+ successful software projects.",
  path: "/about",
});
    ...
    <MainLayout>
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 text-zinc-400 leading-relaxed">
                ...
                production-ready software, Kyron Solutions has grown into a trusted
                partner for startups and enterprises worldwide. We believe great software
          ...
          <div className="mt-20">
            <h2 className="mb-8 text-center text-3xl font-bold text-white">Our Values</h2>
