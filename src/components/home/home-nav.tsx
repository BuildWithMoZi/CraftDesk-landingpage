    ...
    <header className='relative z-30 px-4 pt-5 sm:px-6 md:px-8'>
      <div className='flex items-center justify-between gap-3'>
        ...
        <div className='hidden items-center gap-2 sm:flex'>
          ...
          <Link
            href='/contact'
            className='flex items-center gap-2 text-sm font-medium text-[var(--foreground)] transition-colors duration-200 hover:text-[var(--orange)]'>
            Create Account
        ...
        <motion.div
          ...
          <div className='relative w-full max-w-[min(100%,22rem)] min-[400px]:max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-4xl'>
            <div className='bottom-nav-glow-ring w-full rounded-full'>
              ...
              <div className='bottom-nav-inner relative flex w-full min-w-0 items-center gap-1 rounded-full bg-[var(--surface-elevated)] px-1.5 py-1.5 shadow-lg shadow-black/50 backdrop-blur-xl min-[400px]:gap-1.5 min-[400px]:px-2 min-[400px]:py-2 sm:gap-2 sm:px-2.5 sm:py-2 lg:px-3 lg:py-2.5'>
                <Link
                  href='/'
                ...
                <Link
                  href='/contact'
                  onClick={() => handleLinkClick("/contact")}
                  className='flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[var(--subtle)] text-[var(--foreground)] transition-colors hover:bg-[var(--subtle-strong)] hover:text-[var(--orange)] min-[400px]:h-9 min-[400px]:w-9 sm:h-10 sm:w-10'
